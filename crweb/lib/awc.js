...
class HComponent extends HLinkedList{
    ...
    addDocumentListener(l){
        ...
        this.addEvent("eventTest", "change", (windowEvent) => {l.documentChanged(new DocumentEvent("change",this,windowEvent))});
    }
    addKeyListener(l){
...
class HWindow extends HLinkedList{
    ...
    addDocumentListener(l){
        ...
        this.addEvent("eventTest", "change", () => {l.documentChanged(new DocumentEvent("change",this))});
    }
    addScrollListener(l){
        this.addWindowEvent("eventTest", "scroll", () => {l.scrolled(new WindowEvent("scroll",this))})
    }
...
class HEmbed extends HComponent{
    /**
     *
     * @param {String}id
     * @param {String}src
...
class HWhiteSpace extends HStyle {
...
class HIcon extends HComponent{
     ...
     * @param text
     */
    constructor(id, icons =[], text=""){
        super('i',id);
        this.setTextContent(text);
        icons.forEach((classE)=>{
            this.domElement.classList.add(classE)
        });
        return this;
    }
...
class HInput extends HComponent{
    ...
    constructor(id,type, name='',maxLength,placeholder){
        ...
        this.domElement.name=name;
        this.domElement.autocomplete=name;
...
let WhiteSpace = function (whitespace = ""){ return new HWhiteSpace(whitespace)};
let Opacity = function (opacity){ return new HOpacity(opacity)};
let Division = function (id){ return new HDivision(id)};
let Embed = function (id,src){ return new HEmbed(id,src)};
